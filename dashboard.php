      ...
      <section style="background-color: #eee;" class="mt-5">
          <div class="row">
            ...
            <div class="col-lg-8">
              ...
              <div class="row">
                <div class="col-md-6">
                    <button class="btn btn-success "><a href="contact_details.php" class="text-white">Contact Details</a></button>
                    <button class="btn btn-success"><a href="contact_details.php" class="text-white">View Ture Guide Request</a></button>
                    <button class="btn btn-success"><a href="contact_details.php" class="text-white">View Feedback</a></button>
                </div>
              </div>
            </div>
          </div>
